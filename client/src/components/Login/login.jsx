...
function Login() {
    ...
    const registerHandler = async (e) => {
        e.preventDefault()
        await axios.post('http://localhost:3001/users', register, {withCredentials: true})
        .then(response => {
    ...
    const login = (e) => {
        e.preventDefault()
        axios.post('http://localhost:3001/users/login',{userName: input.username, password: input.password}, {withCredentials: true })
        .then(response => {
